...
||text under spoiler||: <span class="tg-spoiler">text under spoiler</span>` );
        ...
        async _showAddMediaPrompt ( ctx ) {
            const text = l10nt( `Send me media files (photos, videos, audios, documents) to add to the message.
                            ...
                            [
                                {
                                    ...
                                    "callback_data": this.createCallbackData( "delete_media", Uuid.new( media.id ).buffer ),
                                },
                            ],
                        ],
                    },
