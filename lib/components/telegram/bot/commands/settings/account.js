    ...
    class extends Super {
        ...
        async #requestEmail ( ctx, message ) {
            ...
            return ctx.sendMessage( {
                "text": l10nt( "To sign in, please, enter your email address" ),
            } );
        }
        ...
        async #requestEmailConfirmation ( ctx ) {
            ...
            const res = await ctx.sendMessage( {
                "text": l10nt( `To complete sign in, please, click the link I just sent to your email address.
If you didn't receive email in several minutes, you can send it again.` ),
                "reply_markup": {
                    "inline_keyboard": [
                        [
                            {
